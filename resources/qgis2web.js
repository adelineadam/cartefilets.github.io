...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:2154',
            extent: [-20037508.342789, -10488397.728026, 20037508.342789, 15538711.096309],
            units: 'm'})
    })
});


map.getView().fit([-20037508.342789, -10488397.728026, 20037508.342789, 15538711.096309], map.getSize());
